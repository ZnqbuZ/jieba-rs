...
* [jieba-rs 分词性能优化记录：提升 2.4 倍](https://messense.me/making-jieba-rs-2-4x-faster-zh-cn)
* [Making jieba-rs 2.4x faster](https://messense.me/making-jieba-rs-2-4x-faster)
...
* [`WasmJieba` WebAssembly bindings for Web and Node.js](https://github.com/ZnqbuZ/WasmJieba)
